...
typedef enum 
{
    RFAL_WUM_PERIDOD_10MS                = 0x00,     /*!< Wake-Up timer 10ms                          */
    RFAL_WUM_PERIDOD_20MS                = 0x01,     /*!< Wake-Up timer 20ms                          */
    RFAL_WUM_PERIDOD_30MS                = 0x02,     /*!< Wake-Up timer 30ms                          */
    RFAL_WUM_PERIDOD_40MS                = 0x03,     /*!< Wake-Up timer 40ms                          */
    RFAL_WUM_PERIDOD_50MS                = 0x04,     /*!< Wake-Up timer 50ms                          */
    RFAL_WUM_PERIDOD_60MS                = 0x05,     /*!< Wake-Up timer 60ms                          */
    RFAL_WUM_PERIDOD_70MS                = 0x06,     /*!< Wake-Up timer 70ms                          */
    RFAL_WUM_PERIDOD_80MS                = 0x07,     /*!< Wake-Up timer 80ms                          */
    RFAL_WUM_PERIDOD_100MS               = 0x10,     /*!< Wake-Up timer 100ms                         */
    RFAL_WUM_PERIDOD_200MS               = 0x11,     /*!< Wake-Up timer 200ms                         */
    RFAL_WUM_PERIDOD_300MS               = 0x12,     /*!< Wake-Up timer 300ms                         */
    RFAL_WUM_PERIDOD_400MS               = 0x13,     /*!< Wake-Up timer 400ms                         */
    RFAL_WUM_PERIDOD_500MS               = 0x14,     /*!< Wake-Up timer 500ms                         */
    RFAL_WUM_PERIDOD_600MS               = 0x15,     /*!< Wake-Up timer 600ms                         */
    RFAL_WUM_PERIDOD_700MS               = 0x16,     /*!< Wake-Up timer 700ms                         */
    RFAL_WUM_PERIDOD_800MS               = 0x17,     /*!< Wake-Up timer 800ms                         */
} rfalWumPeriod;
...
typedef struct 
{
    rfalWumPeriod        period;     /*!<  Wake-Up Timer period; how often the measurement(s) is performed */
    bool                 irqTout;    /*!<  IRQ at every timeout will refresh the measurement(s) value(s)   */
  
    struct{
        bool             enabled;           /*!< Inductive Amplitude measurement enabled                  */
        uint8_t          delta;             /*!< Delta between the reference and measurement to wake-up   */
        uint8_t          reference;         /*!< Reference to be used;RFAL_WUM_REFRENCE_AUTO sets it auto */
...
#define RFAL_WUM_REFRENCE_AUTO                 0xFF    /*!< Indicates new reference is set by the driver   */
#define RFAL_WUM_WAKEMASK_INDAMP               0x01    /*!< Wake-Up mode was woken by Inductive Amplitude  */
#define RFAL_WUM_WAKEMASK_INDPHA               0x02    /*!< Wake-Up mode was woken by Inductive Phase      */
#define RFAL_WUM_WAKEMASK_CAP                  0x04    /*!< Wake-Up mode was woken by Capacitive           */
